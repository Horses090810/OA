...
<body>
    ...
    <form action="/bwxqym.do" method="post">
        <table width="600px" style="text-align: center;margin-left: 300px;">
            ...
            <tr>
                <td colspan="2"><input type="text" style="width: 600px;height: 30px;"name="notetitle" value="${list.notetitle}"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="button"<c:if test="${list!=null}"> onclick="scff(${list.noteid})" </c:if>value="删除当前便签"></td>
            </tr>
        </table>
    </form>
</body>
