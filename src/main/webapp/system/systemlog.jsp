    ...
    <div>
        <div class="row" style="width: 100%;margin-left: 0px;">
            <div class="col-lg-12" style="width: 100%;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><i class="fa fa-undo"></i><a href="">操作日志</a></li>
                </ol>
            </div>
        </div>
        <div>
            <div align="center">
                <form action="systemLog.do" method="post">
                    <span>输入时间段</span>
        ...
        <div style="margin-top: 20px;">
            <table class="table table-striped table-advance table-hover">
                <tbody>
                <tr>
                    <th><i class="icon_cogs"></i>序号</th>
                    <th><i class="icon_calendar"></i>操作用户</th>
                    <th><i class="icon_cogs"></i>事件</th>
                    <th><i class="icon_cogs"></i>操作描述</th>
                    <th><i class="icon_cogs"></i>操作时间</th>
                </tr>
                <c:forEach items="${operatelogAll}" var="l" varStatus="s">
                    <tr>
                        <td>${s.count}</td>
                        <td>${l.userid}</td>
                        <td>${l.operatename}</td>
...
<script>
    $('#pageLimit').bootstrapPaginator({
        ...
        pageUrl:function(type,page,current){
            ...
            if (days!=''){
                return "systemLog.do?pageNo="+page+"&time1="+$('#time1').val()+"&time2="+$('#time2').val()+"&days="+days;
            }else{
                return "systemLog.do?pageNo="+page+"&time1="+$('#time1').val()+"&time2="+$('#time2').val()+"&days=";
            }
