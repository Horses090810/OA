...
<html lang="en">
  ...
  <section id="container" class="">
      <header class="header dark-bg">
          ...
          <a href="index.jsp" class="logo">MY <span class="lite">OFFICE</span></a>
                    ...
                    <img alt="" src="img/avatar1_small.jpg">
                      ...
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li class="eborder-top">
                              <a href="logout.do"><i class="icon_profile"></i> 退出登录</a>
                          </li>
                          <li>
                          ...
                          <li class="sub-menu">
                              ...
                              <ul class="sub">
                                  <c:forEach items="${list}" var="d">
                                      <c:if test="${d.parentnodeid==l.parentnodeid && d.displayname!=l.enmu}">
                                          <li><a class="" href="${pageContext.request.contextPath}/${d.nodeurl}" target="right">${d.displayname}</a></li>
                                      </c:if>
                                  </c:forEach>
                              </ul>
                          </li>
